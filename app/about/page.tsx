        ...
        <section className="py-26 px-6 sm:px-8 lg:px-12">
          <div className="max-w-7xl mx-auto">
            ...
            <p className="text-4xl text-black font-bold leading-relaxed w-3/4 mb-10">
              I am a Global Business and Digital Arts student at the University of
              Waterloo, aiming to explore and grow my expertise in design thinking
            ...
            <div className="grid grid-cols-[75%_25%] gap-12">
              ...
              <div className="flex justify-center items-center">
                <p className="text-xl text-black text-right">
                  I'm dedicated to crafting beautiful and highly functional designs
                  that seamlessly align with my clients' unique needs and long-term
                  goals.
                </p>
              </div>
            </div>
